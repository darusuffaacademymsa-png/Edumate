      ...
      <div className="max-w-6xl mx-auto">
        ...
        {activeTab === 'students' && (
          <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
            ...
            <div className="w-full border border-slate-200 dark:border-slate-700 rounded-xl my-4 overflow-hidden">
              <table className="w-full text-left border-collapse break-words">
                <thead>
                  <tr className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700">
                    <th className="px-1.5 py-2 sm:p-4 font-bold text-slate-700 dark:text-slate-300 text-[10px] sm:text-sm leading-tight">Student Name</th>
                    <th className="px-1.5 py-2 sm:p-4 font-bold text-slate-700 dark:text-slate-300 text-[10px] sm:text-sm leading-tight">Chapter Progress</th>
                    <th className="px-1.5 py-2 sm:p-4 font-bold text-slate-700 dark:text-slate-300 text-[10px] sm:text-sm leading-tight">Quiz Avg</th>
                    <th className="px-1.5 py-2 sm:p-4 font-bold text-slate-700 dark:text-slate-300 text-[10px] sm:text-sm leading-tight">Last Active</th>
                    <th className="px-1.5 py-2 sm:p-4 font-bold text-slate-700 dark:text-slate-300 text-[10px] sm:text-sm leading-tight">Status</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 dark:divide-slate-700/50">
                  {[
                    ...
                    <tr key={i} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 transition-colors">
                      <td className="px-1.5 py-2 sm:p-4 font-bold text-slate-900 dark:text-white text-xs sm:text-sm leading-tight break-words">{student.name}</td>
                      <td className="px-1.5 py-2 sm:p-4 min-w-[60px] sm:min-w-[150px]">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                          <div className="w-full bg-slate-100 dark:bg-slate-700 rounded-full h-1.5 sm:h-2">
                            <div className="bg-indigo-500 h-1.5 sm:h-2 rounded-full" style={{ width: `${student.progress}%` }}></div>
                          </div>
                          <span className="text-[10px] sm:text-xs text-slate-500 dark:text-slate-400 font-bold">{student.progress}%</span>
                        </div>
                      </td>
                      <td className="px-1.5 py-2 sm:p-4 text-slate-700 dark:text-slate-300 text-xs sm:text-sm">{student.quiz}%</td>
                      <td className="px-1.5 py-2 sm:p-4 text-slate-500 dark:text-slate-400 text-[10px] sm:text-sm leading-tight break-words">{student.lastActive}</td>
                      <td className="px-1.5 py-2 sm:p-4 leading-tight">
                        <span className={`px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full text-[9px] sm:text-xs font-bold ${
